...
Output = Pool.map(get_mag_count, k_split)
...
plt.savefig("Quasar_mag_counts_g_mp.png", dpi=200)

plt.show()

#Save the results.
np.savetxt("Quasar_mag_counts_g_mp.dat", np.array([m_grid, Ntot[0], Ntot[1], Ntot[2]]))
